"""
Django settings for cryptoPricesSpaceProject project.
...
ROOT_URLCONF = 'cryptoPricesSpaceProject.urls'
...
WSGI_APPLICATION = 'cryptoPricesSpaceProject.wsgi.application'
